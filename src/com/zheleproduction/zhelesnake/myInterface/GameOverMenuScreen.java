...
public class GameOverMenuScreen extends SlideScreen
{
	...
	public GameOverMenuScreen(float w,float h)
	{
		super(w,h);
	...
	void initButtons()
	{
		...
		buttons[2].setBlackRect(w/2f-1f/6*w,h/2f-4*w/12f,w/2f+1f/6*w,h/2f-2*w/12f);
